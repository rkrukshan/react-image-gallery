  ...
  return (
    <div className="">
      ...
      <div className="flex justify-center mt-10 mx-auto">
        <button className="btn" onChange={}>Brain</button>
        <button className="btn" onChange={}>CODE</button>
        <button className="btn" onChange={}> Tech</button>
        <button className="btn" onChange={}>React</button>
        <button className="btn" onChange={}>JS</button>
      </div>
    </div>
  );
}
