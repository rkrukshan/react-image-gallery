...
export default function Gallery() {
  ...
  return (
    <div className="">
      ...
      <div className="flex gap-5 flex-wrap justify-center mt-">
  {img.map((pic) => {
    return (
      <div key={pic.id} className="flex-shrink-0">
        <img className="w-96 h-96" src={pic.urls.small} alt={pic.alt_description} />
      </div>
    );
  })}
</div>
