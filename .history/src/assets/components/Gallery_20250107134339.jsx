  ...
  return (
    <div className="">
      ...
      <div className="flex justify-center mt-10 mx-auto">
        <button className="btn" onChange={()=>btnSearch("Brain")}>Brain</button>
        <button className="btn" onChange={()=>btnSearch("CODE")}>CODE</button>
        <button className="btn" onChange={()=>btnSearch("Tech")}> Tech</button>
        <button className="btn" onChange={()=>btnSearch("React")}>React</button>
        <button className="btn" onChange={()=>btnSearch("JS")}>JS</button>
      </div>
    </div>
  );
}
