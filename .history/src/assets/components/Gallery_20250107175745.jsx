...
export default function Gallery() {
  ...
  return (
    <div>
      ...
      <div className="grid mb-5 lg:flex justify-center mt-10 mx-auto">
        ...
        {img.map((pic) => {
          return (
            <div key={pic.id} className="">
              <img
                className="w-96 h-96 transition-all hover:scale-110 hover:ring-8 ring-blue-300 hover:cursor-pointer hover:shadow-3xl shadow-black rounded-xl "
                src={pic.urls.small}
