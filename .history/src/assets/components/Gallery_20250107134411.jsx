  ...
  return (
    <div className="">
      ...
      <div className="flex justify-center mt-10 mx-auto">
        <button className="btn" onC={()=>btnSearch("Brain")}>Brain</button>
        <button className="btn" onC={()=>btnSearch("CODE")}>CODE</button>
        <button className="btn" onC={()=>btnSearch("Tech")}> Tech</button>
        <button className="btn" onC={()=>btnSearch("React")}>React</button>
        <button className="btn" onC={()=>btnSearch("JS")}>JS</button>
      </div>
    </div>
  );
}
